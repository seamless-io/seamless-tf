...
resource "aws_elastic_beanstalk_environment" "web-prod-env" {
  ...
  setting {
        namespace = "aws:autoscaling:launchconfiguration"
        name      = "IamInstanceProfile"
        value     = "arn:aws:iam::202868668807:instance-profile/aws-elasticbeanstalk-ec2-role"  # Without thi ec2 instances won't be able to communicate with ECS. The role is autogenerated by beanstalk but is not automatically attached to instances for some reasons.
      }
}